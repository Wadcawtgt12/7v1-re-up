...
const nyoutube = ('Web Mimin: \nhttp://animeforallhuman.blogspot.com/')  //ubah di config biar ngk emror
...
*Silahkan* @${m.mentionedJid[0].split`@`[0]} *untuk ketik terima/tolak*`
	    ...
	    case 'donasi': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
                naze.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/4b240028d38b028d84656.jpg' }, caption: `*${ucapanWaktu} Kak ${m.pushName}*\n\n *Jika ingin berdonasi silahkan scan gambar diatas*\n\n*Atau Transfer via*\n- *Dana Pulsa*\n Ke nomer berikut : 0895411143170\n\n_Terima kasih bagi yang sudah donasi_` }, { quoted: m })
            }
            break
            case 'chat': {
...
case 'introda3old': case 'da3old':{
	...
	break
		case 'introda3old1': case 'da3old1':{
			if (!m.isGroup) throw mess.group
                if (!isBotAdmins) throw mess.botAdmin
					await 
...
case 'introdaold1': case 'daold1':{
			if (!m.isGroup) throw mess.group
					await 
    m.reply('*『WELLCOME TO DUNIA ANIME』* \n•═══════════════════•\n                *INTRO*\n• *Nama :*\n \n• *Umur :* \n\n• *Asal kota :* \n\n• *Anime/manga/manhua/manhwa favorit :* \n\n• *Karakter favorit :* \n\n•═══════════════════•\n\n ```♡Selamat bergabung semoga betah♡```')
}
	break
case 'introda': case 'da':{
			if (!m.isGroup) throw mess.group
					await 
    m.reply('『WELLCOME TO DUNIA ANIME』 \n•═══════════════════•\n                INTRO\n• Nama :\n\n• Umur : \n\n• Asal kota :\n\n• Anime favorit :\n\n• Wibu/otaku/cosplayer :\n\n•═══════════════════•\n\n ♡Selamat bergabung semoga betah♡')
}
	break
case 'introda1old1': case 'da1old1':{
			if (!m.isGroup) throw mess.group
					await 
    m.reply('*『WELLCOME TO DUNIA ANIME』* \n•═══════════════════•\n                *INTRO*\n• *Nama :*\n \n• *Umur :* \n\n• *Asal kota :* \n\n• *Anime/manga/manhua/manhwa favorit :* \n\n• *Karakter favorit :* \n\n•═══════════════════•\n\n ```♡Selamat bergabung semoga betah♡```')
}
...
case 'introda1': case 'da1':{
	...
	break
case 'introda2old1': case 'da2old1':{
			if (!m.isGroup) throw mess.group
					await 
    m.reply('*『WELLCOME TO DUNIA ANIME』* \n•═══════════════════•\n                *INTRO*\n• *Nama :*\n \n• *Umur :* \n\n• *Asal kota :* \n\n• *Anime/manga/manhua/manhwa favorit :* \n\n*• Menggambar/art :* \n\n•═══════════════════•\n\n ```♡Selamat bergabung semoga betah♡```')
}
	...
	break
case 'introdaofcold1': case 'daofcold1':{
			if (!m.isGroup) throw mess.group
					await 
    m.reply('*『WELLCOME TO DUNIA ANIME』* \n•═══════════════════•\n                *INTRO*\n• *Nama :*\n \n• *Umur :* \n\n• *Asal kota :* \n\n• *Anime/manga/manhua/manhwa favorit :* \n\n• *Karakter favorit :* \n\n•═══════════════════•\n\n ```♡Selamat bergabung semoga betah♡```')
}
...
case 'rulesda': case 'rda':{
	...
	break
case 'sayangku': case 'sayang':{
					await 
    m.reply('Iya Sayang, Kenapa?')
}
	break
case 'kangen':{
					await 
    m.reply('AHhh aku juga kangen ama kamu')
}
	break
case 'beneran':{
					await 
    m.reply('Iya Sayang, beneran ngapain juga aku bohong ama kamu yang lucu')
}
	break
case 'welcome':{
			if (!m.isGroup) throw mess.group
